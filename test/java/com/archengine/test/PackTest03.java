 ...
 */
package com.archengine.test;

import com.archengine.db.Connection;
import com.archengine.db.Cursor;
import com.archengine.db.PackOutputStream;
import com.archengine.db.PackInputStream;
import com.archengine.db.Session;
import com.archengine.db.ArchEngineException;
import com.archengine.db.ArchEnginePackingException;
import com.archengine.db.archengine;
...
public class PackTest03 {
    ...
    throws ArchEnginePackingException {
        ...
        catch (ArchEnginePackingException pe) {
    ...
    private void setup() {
        connection = archengine.open("AE_HOME", "create");
    ...
    public static void main(String[] args) {
        ...
        } catch (ArchEnginePackingException aepe) {
            System.err.println("Packing exception: " + aepe);
        }
    }
}
