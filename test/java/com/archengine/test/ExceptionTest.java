...
import com.archengine.db.ArchEngineRollbackException;
...
public class ExceptionTest {
    ...
    public void except02() {
        ...
        try {
            ...
            Assert.assertEquals(aee.getClass(), ArchEngineException.class);
            caught = true;
        }
    ...
    public void except03() throws IOException {
        ...
        catch (ArchEngineRollbackException rbe) {
            caught = true;
        }
        catch (Exception e) {
    ...
    private void setup(String uriparam, String keyFormat, String valueFormat) {
        uri = uriparam;
        conn = archengine.open("AE_HOME", "create");
