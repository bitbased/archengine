...
Version:	2.7.0
Release:	1%{?dist}
Summary:	ArchEngine data storage engine

Group:		Development/Libraries
License:	GPLV2 or GPLV3
URL:		www.archengine.com
Source0:	http://source.archengine.com/releases/%{name}-%{version}.tar.bz2
...
ArchEngine is a data storage engine that provides APIs for efficiently
...
ArchEngine is a library that can be accessed via C, Python and Java APIs.
