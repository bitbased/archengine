...
#ifndef	HAVE_AEPERF_H
#define	HAVE_AEPERF_H
...
#define	BZIP_EXT							\
	EXT_PFX EXTPATH "bzip2/.libs/libarchengine_bzip2.so" EXT_SFX
#define	LZ4_BLK BLKCMP_PFX "lz4"
#define	LZ4_EXT							\
	EXT_PFX EXTPATH "lz4/.libs/libarchengine_lz4.so" EXT_SFX
#define	SNAPPY_BLK BLKCMP_PFX "snappy"
#define	SNAPPY_EXT							\
	EXT_PFX EXTPATH "snappy/.libs/libarchengine_snappy.so" EXT_SFX
#define	ZLIB_BLK BLKCMP_PFX "zlib"
#define	ZLIB_EXT							\
	EXT_PFX EXTPATH "zlib/.libs/libarchengine_zlib.so" EXT_SFX
 ...
 * an initialization in aeperf.c in the default_cfg.
 */
struct __config {			/* Configuration structure */
	const char *home;		/* ArchEngine home */
	...
	AE_CONNECTION *conn;		/* Database connection */
...
#define	WORKLOAD_MAX	50
	...
	/* Fields changeable on command line are listed in aeperf_opt.i */
...
int	 run_truncate(
    CONFIG *, CONFIG_THREAD *, AE_CURSOR *, AE_SESSION *, int *);
int	 setup_log_file(CONFIG *);
int	 setup_truncate(CONFIG *, CONFIG_THREAD *, AE_SESSION *);
