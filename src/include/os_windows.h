 ...
 */
typedef CONDITION_VARIABLE	ae_cond_t;
 ...
 */
#define	AE_THREAD_CALLBACK(x)	unsigned (__stdcall x)
#define	AE_THREAD_RET		unsigned __stdcall
#define	AE_THREAD_RET_VALUE	0
 ...
 * Eventually ArchEngine will migrate away from these types
 */
 ...
 */
#define	vsnprintf _ae_vsnprintf
