...
public class ex_log {
    ...
    public static String home1 = "AE_HOME_LOG_1";
    public static String home2 = "AE_HOME_LOG_2";
        ...
        throws ArchEngineException
    {
        ...
        conn = archengine.open(home2, CONN_CONFIG);
        ...
        throws ArchEngineException
    {
        ...
        if (ret != archengine.AE_NOTFOUND)
            System.err.println("AE_CURSOR.next: " +
       ...
       byte[] key, byte[] value)
    {
        ...
        if (rectype == archengine.AE_LOGREC_MESSAGE)
        ...
        throws ArchEngineException
    {
        ...
        session2 = setup_copy();
        ae_conn2 = session2.getConnection();
        cursor = session.open_cursor("log:", null, null);
        ...
        while ((ret = cursor.next()) == 0) {
             ...
             */
            if (fileid == 1 && rectype == archengine.AE_LOGREC_COMMIT &&
                optype == archengine.AE_LOGOP_ROW_PUT) {
                if (!in_txn) {
        ...
        throws ArchEngineException
    {
        ...
        if ((ae_conn = archengine.open(home1, CONN_CONFIG)) == null) {
            System.err.println("Error connecting to " + home1);
            return (1);
        }

        session = ae_conn.open_session(null);
